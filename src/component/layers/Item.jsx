...
const Item = ({productTitle,productImg,productPrice,productTag,productColor,productid}) => {
    const navigate = useNavigate();
    return (
        <>
            <div className="item 2xl:w-[370px] 2xl:xl:w-[300px] lg:w-[232px] md:w-[240px] sm:w-[290px] cursor-pointer relative group" onClick={()=>{navigate("/product",{state:{pprices:productPrice,ptitle:productTitle,ptag:productTag,pimg:productImg,pcolor:productColor,pids:productid}})}}>
                ...
                <div className="2xl:h-[370px] 2xl:w-[370px] xl:w-[300px] xl:h-[300px] lg:w-[232px] lg:h-[232px] bg-red-200">
                ...
                <div className="overlay absolute left-0 bottom-0 group-hover:bottom-[85px] opacity-0 group-hover:opacity-100 transition-all duration-100 bg-[#fff] z-10 w-full 2xl:h-[156px] xl:h-[100px]">
                        <ul className='text-right pr-[30px] py-[26px] h-full flex flex-col justify-between'>
                            ...
                            <li><a className='font-normal text-base text-right text-[#767676] font-dm' href="#" onClick={()=>{navigate("/product",{state:{pprices:productPrice,ptitle:productTitle,ptag:productTag,pimg:productImg,pcolor:productColor,pids:productid}})}}>Add to Cart <img className='inline-block pl-4 my' src={cart} alt="" /></a></li>
                        </ul>
                    </div>
            </div>
        </>
